...
DROP TABLE "FLIGHT_DEV"."ADR_ADDRESS";
DROP TABLE "FLIGHT_DEV"."ADR_CITY";
DROP TABLE "FLIGHT_DEV"."ADR_COUNTRY";
DROP TABLE "FLIGHT_DEV"."APL_ENGINE_TYPE";
DROP TABLE "FLIGHT_DEV"."APL_MAINT";
DROP TABLE "FLIGHT_DEV"."APL_MAINT_PROGR";
DROP TABLE "FLIGHT_DEV"."APL_PLANE";
DROP TABLE "FLIGHT_DEV"."APL_PLANE_MODELL";
DROP TABLE "FLIGHT_DEV"."APL_PLANE_TYPE";
DROP TABLE "FLIGHT_DEV"."ARP_AIRPORT";
DROP TABLE "FLIGHT_DEV"."BAK_BANKACCOUNT";
DROP TABLE "FLIGHT_DEV"."BAK_BANKACCOUNT_TYPE";
DROP TABLE "FLIGHT_DEV"."BAS_BASIC";
DROP TABLE "FLIGHT_DEV"."BAS_BASIC_GRP";
DROP TABLE "FLIGHT_DEV"."BOR_BORD_LOG";
DROP TABLE "FLIGHT_DEV"."BOR_BORD_LOG_ENTRY";
DROP TABLE "FLIGHT_DEV"."BOR_BORD_LOG_ENTRY_ADD";
DROP TABLE "FLIGHT_DEV"."BOR_BORD_LOG_ENTRY_GRP";
DROP TABLE "FLIGHT_DEV"."BOR_BORD_LOG_ENTRY_HOB_RPM";
DROP TABLE "FLIGHT_DEV"."CON_CONTACT";
DROP TABLE "FLIGHT_DEV"."CON_CONTACT_TYPE";
DROP TABLE "FLIGHT_DEV"."COST_COST_GRP";
DROP TABLE "FLIGHT_DEV"."DEPT";
DROP TABLE "FLIGHT_DEV"."DOC_DOCUMENT";
DROP TABLE "FLIGHT_DEV"."DOC_DOCUMENT_TYPE";
DROP TABLE "FLIGHT_DEV"."DOC_USAGE_TYPE";
DROP TABLE "FLIGHT_DEV"."EMP";
DROP TABLE "FLIGHT_DEV"."FLI_FLIGHT";
DROP TABLE "FLIGHT_DEV"."FLI_FLIGHT_COMMENTS";
DROP TABLE "FLIGHT_DEV"."FLI_FLIGHT_DISCOUNT_REASONS";
DROP TABLE "FLIGHT_DEV"."FLI_FLIGHT_DISCOUNTS";
DROP TABLE "FLIGHT_DEV"."GAL_GAIN_AND_LOSS";
DROP TABLE "FLIGHT_DEV"."HAN_HANGAR";
DROP TABLE "FLIGHT_DEV"."INV_INVOICE";
DROP TABLE "FLIGHT_DEV"."INV_INVOICE_TYPE";
DROP TABLE "FLIGHT_DEV"."LAN_LANDING";
DROP TABLE "FLIGHT_DEV"."MDT_MANDANT";
DROP TABLE "FLIGHT_DEV"."ORG_UNIT";
DROP TABLE "FLIGHT_DEV"."ORG_UNIT_CHECK_OUT";
DROP TABLE "FLIGHT_DEV"."ORG_UNIT_REL_TYPE";
DROP TABLE "FLIGHT_DEV"."ORG_UNIT_TYPE";
DROP TABLE "FLIGHT_DEV"."PAY_PAYMENT";
DROP TABLE "FLIGHT_DEV"."PAY_PAYMENT_TYPE";
DROP TABLE "FLIGHT_DEV"."PLA_ENGINE_TYPE";
DROP TABLE "FLIGHT_DEV"."REL_AIRPORT_LOCATION";
DROP TABLE "FLIGHT_DEV"."REL_BORD_LOG_ENTRY_PAY";
DROP TABLE "FLIGHT_DEV"."REL_CONTACT_ADDRESS";
DROP TABLE "FLIGHT_DEV"."REL_CONTACT_BANKACCOUNT";
DROP TABLE "FLIGHT_DEV"."REL_DOC_CONTACT";
DROP TABLE "FLIGHT_DEV"."REL_DOC_FLIGHT";
DROP TABLE "FLIGHT_DEV"."REL_DOC_HANGAR";
DROP TABLE "FLIGHT_DEV"."REL_DOC_PLANE";
DROP TABLE "FLIGHT_DEV"."REL_DOC_TYPE_USAGE_TYPE";
DROP TABLE "FLIGHT_DEV"."REL_INV_PL_FLI_CH";
DROP TABLE "FLIGHT_DEV"."REL_ORG_UNIT_CON";
DROP TABLE "FLIGHT_DEV"."REL_ORG_UNIT_CON_ORG_REL_TYPE";
DROP TABLE "FLIGHT_DEV"."REL_PAY_PLANE_FLI_CH";
DROP TABLE "FLIGHT_DEV"."REL_PLANE_FLIGHT";
DROP TABLE "FLIGHT_DEV"."REL_PLANE_FLIGHT_CHARTERER";
DROP TABLE "FLIGHT_DEV"."RES_RESERVATION";
