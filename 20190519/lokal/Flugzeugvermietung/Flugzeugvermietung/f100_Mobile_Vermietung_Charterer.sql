...
prompt APPLICATION 109 - Mobile - Vemietung - Charterer
--
-- Application Export:
--   Application:     109
--   Name:            Mobile - Vemietung - Charterer
--   Date and Time:   22:51 Sonntag Mai 19, 2019
...
,p_authentication_id=>wwv_flow_api.id(19198592358827647)
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(19190036567827634)
,p_name=>'Mobile Navigation Menu'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(19200491554827653)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(19189424422827633)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(19189500432827633)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(19189626343827633)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(19189761459827633)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(19189894562827633)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'modern'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(19189989520827634)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(19198497541827646)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(19199650819827649)
,p_name=>' Breadcrumb'
);
end;
/
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(19190178893827634)
,p_theme_id=>51
,p_name=>'Dialog'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(19190225874827635)
,p_theme_id=>51
,p_name=>'Page'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(19190793672827636)
,p_theme_id=>51
,p_name=>'Popup'
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(19193147526827640)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(19197303093827643)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(19190841314827636)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(19190917993827636)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(19191045372827636)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(19191186701827637)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(19191275536827637)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(19191326973827637)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(19191417418827637)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(19191582688827637)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(19191696524827637)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(19191748309827638)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(19191811427827638)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(19191984205827638)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(19192041189827638)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(19192156810827638)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(19192386147827638)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(19192418110827639)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(19192568781827639)
,p_list_template_current=>'<li data-theme="b"><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(19192698522827639)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(19192711272827639)
,p_list_template_current=>'<li data-theme="b"><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(19192270674827638)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(19192819114827640)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(19192930402827640)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(19193028202827640)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(19197759725827645)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(19197685716827643)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(19198256973827646)
,p_theme_id=>51
,p_theme_name=>'Mobile'
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(19190225874827635)
,p_default_dialog_template=>wwv_flow_api.id(19190178893827634)
,p_error_template=>wwv_flow_api.id(19190225874827635)
,p_printer_friendly_template=>wwv_flow_api.id(19190225874827635)
,p_login_template=>wwv_flow_api.id(19190225874827635)
,p_default_button_template=>wwv_flow_api.id(19197303093827643)
,p_default_region_template=>wwv_flow_api.id(19191984205827638)
,p_default_chart_template=>wwv_flow_api.id(19191984205827638)
,p_default_form_template=>wwv_flow_api.id(19191984205827638)
,p_default_reportr_template=>wwv_flow_api.id(19192156810827638)
,p_default_tabform_template=>wwv_flow_api.id(19191984205827638)
,p_default_wizard_template=>wwv_flow_api.id(19191984205827638)
,p_default_irr_template=>wwv_flow_api.id(19191984205827638)
,p_default_report_template=>wwv_flow_api.id(19192270674827638)
,p_default_label_template=>wwv_flow_api.id(19192930402827640)
,p_default_calendar_template=>wwv_flow_api.id(19197685716827643)
,p_default_list_template=>wwv_flow_api.id(19192568781827639)
,p_default_nav_list_template=>wwv_flow_api.id(19192418110827639)
,p_default_top_nav_list_temp=>wwv_flow_api.id(19192418110827639)
,p_default_side_nav_list_temp=>wwv_flow_api.id(19192711272827639)
,p_default_nav_list_position=>'SIDE'
,p_default_dialogbtnr_template=>wwv_flow_api.id(19190841314827636)
,p_default_dialogr_template=>wwv_flow_api.id(19191984205827638)
,p_default_option_label=>wwv_flow_api.id(19192930402827640)
,p_default_header_template=>wwv_flow_api.id(19191696524827637)
,p_default_footer_template=>wwv_flow_api.id(19191417418827637)
,p_default_required_label=>wwv_flow_api.id(19193028202827640)
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(19197893008827645)
,p_theme_id=>51
,p_name=>'Blue'
,p_css_file_urls=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(19197966515827645)
,p_theme_id=>51
,p_name=>'Dark'
,p_css_file_urls=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(19198082513827645)
,p_theme_id=>51
,p_name=>'Default'
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(19198158306827645)
,p_theme_id=>51
,p_name=>'Red'
,p_css_file_urls=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(19190360013827635)
,p_theme_id=>51
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(19193240311827640)
,p_theme_id=>51
,p_name=>'ICON_BUTTON'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(19193730763827641)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19190449027827635)
,p_theme_id=>51
,p_name=>'OVERLAY'
,p_display_name=>'Overlay'
,p_display_sequence=>1
,p_page_template_id=>wwv_flow_api.id(19190225874827635)
,p_css_classes=>'overlay'
,p_group_id=>wwv_flow_api.id(19190360013827635)
,p_template_types=>'PAGE'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19190586678827636)
,p_theme_id=>51
,p_name=>'PUSH'
,p_display_name=>'Push'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19190627685827636)
,p_theme_id=>51
,p_name=>'REVEAL'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19193340711827640)
,p_theme_id=>51
,p_name=>'ICON_ACTION'
,p_display_name=>'Action'
,p_display_sequence=>100
,p_button_template_id=>wwv_flow_api.id(19193147526827640)
,p_css_classes=>'ui-icon-action'
,p_group_id=>wwv_flow_api.id(19193240311827640)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19193470812827641)
,p_theme_id=>51
,p_name=>'ICON_ALERT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19193569364827641)
,p_theme_id=>51
,p_name=>'ICON_BACK'
,p_display_name=>'Back'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19193606787827641)
,p_theme_id=>51
,p_name=>'ICON_BARS'
,p_display_name=>'Bars'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19193822178827641)
,p_theme_id=>51
,p_name=>'ICON_BOTTOM'
...
,p_group_id=>wwv_flow_api.id(19193730763827641)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19193957703827641)
,p_theme_id=>51
,p_name=>'ICON_BULLETS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19194090695827641)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19194193866827641)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19194229643827641)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19194317997827641)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19194450370827641)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19194595357827641)
,p_theme_id=>51
,p_name=>'ICON_CHECK'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19194651315827641)
,p_theme_id=>51
,p_name=>'ICON_CLOCK'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19194755341827641)
,p_theme_id=>51
,p_name=>'ICON_CLOUD'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19194869525827641)
,p_theme_id=>51
,p_name=>'ICON_COMMENT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19194971366827641)
,p_theme_id=>51
,p_name=>'ICON_DELETE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19195002042827641)
,p_theme_id=>51
,p_name=>'ICON_EDIT'
,p_display_name=>'Edit'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19195103679827641)
,p_theme_id=>51
,p_name=>'ICON_GEAR'
,p_display_name=>'Gear'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19195234814827642)
,p_theme_id=>51
,p_name=>'ICON_GRID'
,p_display_name=>'Grid'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19195358316827642)
,p_theme_id=>51
,p_name=>'ICON_HOME'
,p_display_name=>'Home'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19195468528827642)
,p_theme_id=>51
,p_name=>'ICON_INFO'
,p_display_name=>'Info'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19195576007827642)
,p_theme_id=>51
,p_name=>'ICON_LEFT'
,p_display_name=>'Left'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19195637593827642)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19195717464827642)
,p_theme_id=>51
,p_name=>'ICON_LOCK'
,p_display_name=>'Lock'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19195818880827642)
,p_theme_id=>51
,p_name=>'ICON_MAIL'
,p_display_name=>'Mail'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19195927558827642)
,p_theme_id=>51
,p_name=>'ICON_MINUS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19196004799827642)
,p_theme_id=>51
,p_name=>'ICON_PHONE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19196149608827642)
,p_theme_id=>51
,p_name=>'ICON_PLUS'
,p_display_name=>'Plus'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19196200196827642)
,p_theme_id=>51
,p_name=>'ICON_POWER'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19196329566827642)
,p_theme_id=>51
,p_name=>'ICON_REFRESH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19196413058827643)
,p_theme_id=>51
,p_name=>'ICON_RIGHT'
,p_display_name=>'Right'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19196515759827643)
,p_theme_id=>51
,p_name=>'ICON_SEARCH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19196680075827643)
,p_theme_id=>51
,p_name=>'ICON_STAR'
,p_display_name=>'Star'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19196723042827643)
,p_theme_id=>51
,p_name=>'ICON_TAG'
,p_display_name=>'Tag'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19196862736827643)
,p_theme_id=>51
,p_name=>'ICON_TOP'
,p_display_name=>'Top'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19196978958827643)
,p_theme_id=>51
,p_name=>'ICON_USER'
,p_display_name=>'User'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19197005291827643)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19197184167827643)
,p_theme_id=>51
,p_name=>'NO_TEXT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19197287075827643)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19197434905827643)
,p_theme_id=>51
,p_name=>'INLINE_BUTTON'
,p_display_name=>'Inline Button'
,p_display_sequence=>1
,p_button_template_id=>wwv_flow_api.id(19197303093827643)
,p_css_classes=>'ui-btn-inline'
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(19197594929827643)
,p_theme_id=>51
,p_name=>'ROUNDED_CORNERS'
,p_display_name=>'Rounded Corners'
,p_display_sequence=>1
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(19198592358827647)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(19198393974827646)
,p_ui_type_name=>'JQM_SMARTPHONE'
...
,p_global_page_id=>0
,p_navigation_list_id=>wwv_flow_api.id(19190036567827634)
,p_navigation_list_position=>'SIDE'
,p_navigation_list_template_id=>wwv_flow_api.id(19192711272827639)
...
wwv_flow_api.create_page(
 p_id=>0
,p_user_interface_id=>wwv_flow_api.id(19198393974827646)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(19199916742827650)
,p_plug_name=>'Header'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(19191696524827637)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(19200228320827651)
,p_plug_name=>'Footer'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(19191417418827637)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(19200195360827651)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(19199916742827650)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(19200039650827650)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(19200384096827651)
,p_name=>'open panel'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(19200039650827650)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(19200384096827651)
,p_event_id=>wwv_flow_api.id(19200384096827651)
,p_event_result=>'TRUE'
...
,p_autocomplete_on_off=>'OFF'
,p_step_template=>wwv_flow_api.id(19190225874827635)
,p_page_template_options=>'#DEFAULT#'
,p_dialog_chained=>'Y'
,p_overwrite_navigation_list=>'N'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(19198814145827648)
,p_plug_name=>'Mobile - Vemietung - Charterer'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(19191984205827638)
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(19199152414827648)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(19198814145827648)
,p_button_name=>'LOGIN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(19198984799827648)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(19198814145827648)
,p_prompt=>'username'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(19199088145827648)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(19199366817827649)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(19199285145827649)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(19199582165827649)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(19199498030827649)
,p_process_sequence=>10
