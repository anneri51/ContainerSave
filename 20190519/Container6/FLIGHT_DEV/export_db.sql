...
DROP SEQUENCE "FLIGHT_DEV"."APL_PLANE_SEQ3";
...
DROP SEQUENCE "FLIGHT_DEV"."ARP_AIRPORT_SEQ2";
...
DROP SEQUENCE "FLIGHT_DEV"."BAS_BASIC_GRP_SEQ1";
...
DROP SEQUENCE "FLIGHT_DEV"."BOR_BORD_LOG_ENTRY_SEQ2";
...
DROP SEQUENCE "FLIGHT_DEV"."BOR_BORD_LOG_SEQ4";
...
DROP SEQUENCE "FLIGHT_DEV"."ORG_UNIT_SEQ3";
...
--------------------------------------------------------
--  DDL for Sequence APL_PLANE_SEQ3
--------------------------------------------------------

   CREATE SEQUENCE  "FLIGHT_DEV"."APL_PLANE_SEQ3"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Sequence ARP_AIRPORT_SEQ2
--------------------------------------------------------

   CREATE SEQUENCE  "FLIGHT_DEV"."ARP_AIRPORT_SEQ2"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Sequence BAS_BASIC_GRP_SEQ1
--------------------------------------------------------

   CREATE SEQUENCE  "FLIGHT_DEV"."BAS_BASIC_GRP_SEQ1"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Sequence BOR_BORD_LOG_ENTRY_SEQ2
--------------------------------------------------------

   CREATE SEQUENCE  "FLIGHT_DEV"."BOR_BORD_LOG_ENTRY_SEQ2"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Sequence BOR_BORD_LOG_SEQ4
--------------------------------------------------------

   CREATE SEQUENCE  "FLIGHT_DEV"."BOR_BORD_LOG_SEQ4"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Sequence ORG_UNIT_SEQ3
--------------------------------------------------------

   CREATE SEQUENCE  "FLIGHT_DEV"."ORG_UNIT_SEQ3"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "FLIGHT_DEV"."BAS_BASIC" 
   (	"PK_BAS_BASIC" NUMBER, 
	...
	"BASIC_NAME_DE" VARCHAR2(400 BYTE), 
	"BASIC_VALUE" NUMBER, 
	"BASIC_NAME_EN" VARCHAR2(400 BYTE), 
	"XML" "SYS"."XMLTYPE" 
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "FLIGHT_DEV"."DEPT_PK" ON "FLIGHT_DEV"."DEPT" ("DEPTNO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
BEGIN
  ...
  BEGIN
    IF INSERTING AND :NEW.PK_ARP_AIRPORT IS NULL THEN
      SELECT ARP_AIRPORT_SEQ2.NEXTVAL INTO :NEW.PK_ARP_AIRPORT FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
...
BEGIN
  ...
  BEGIN
    IF INSERTING AND :NEW.PK_BAS_BASIC_GRP IS NULL THEN
      SELECT BAS_BASIC_GRP_SEQ1.NEXTVAL INTO :NEW.PK_BAS_BASIC_GRP FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
...
BEGIN
  ...
  BEGIN
    IF INSERTING AND :NEW.PK_ORG_UNIT IS NULL THEN
      SELECT ORG_UNIT_SEQ3.NEXTVAL INTO :NEW.PK_ORG_UNIT FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
...
--------------------------------------------------------
  ...
  ALTER TABLE "FLIGHT_DEV"."BOR_BORD_LOG_ENTRY" MODIFY ("FK_MDT_MANDANT" NOT NULL ENABLE);
  ALTER TABLE "FLIGHT_DEV"."BOR_BORD_LOG_ENTRY" MODIFY ("PK_BOR_BORD_LOG_ENTRY" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table DEPT
--------------------------------------------------------

  ALTER TABLE "FLIGHT_DEV"."DEPT" ADD CONSTRAINT "DEPT_PK" PRIMARY KEY ("DEPTNO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "FLIGHT_DEV"."DEPT" MODIFY ("DEPTNO" NOT NULL ENABLE);
--------------------------------------------------------
